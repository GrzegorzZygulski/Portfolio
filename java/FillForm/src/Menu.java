...
public class Menu implements ActionListener {
	...
	JMenuItem menuItem;
	JFrame frame;
	Driver tmp; // do inicjalizacji danych
	...
	Menu(JFrame frame) {
		...
		tmp = new Driver(); // musi byæ tu webdrivwr bo dane logowania sa tu inicjalizowane
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source.contains("Menu1ItemA")) {
			...
			Driver.loginData[0] = JOptionPane.showInputDialog("Server URL: ", Driver.loginData[0]);
		}
		...
		if (source.contains("Menu2itemA")) {
			...
			Driver.jobURL = JOptionPane.showInputDialog("Job URL: ", Driver.jobURL);
		}
